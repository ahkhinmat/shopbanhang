    ...
    <div class="table-agile-info">
        ...
        ?>
            <table class="table table-striped b-t b-light">
              ...
              <tbody>
                @foreach ($all_brand_product as $item=>$cate_pro)
                  <tr>
                  ...
                  <td><span class="text-ellipsis">
                    ...
                    <td>
                      <a href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}"class="active styling-edit" ui-toggle-class="" onclick="return confirm('Muốn xóa ko?')">
