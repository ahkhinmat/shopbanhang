              ...
              <tbody>
                @foreach ($all_product as $item=>$pro)
                  <tr>
                    ...
                    <td><img src="public/upload/product/{{$pro->product_image}}" width="150" height="150"></td>
                  ...
                  <td><span class="text-ellipsis">
                    ...
                    <td>
                      <a href="{{URL::to('/delete-product/'.$pro->product_id)}}"class="active styling-edit" ui-toggle-class="" onclick="return confirm('Muốn xóa ko?')">
