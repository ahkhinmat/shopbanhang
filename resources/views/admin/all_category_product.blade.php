              ...
              <tbody>
                @foreach ($all_category_product as $item=>$cate_pro)
                  ...
                  <td>{{$cate_pro->category_name}}</td>
                    {{-- <td><span class="text-ellipsis">{{$cate_pro->category_ngaythem}}</span></td> --}}
                  <td><span class="text-ellipsis">
                    ...
                    <td>
                      <a href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}"class="active styling-edit" ui-toggle-class="" onclick="return confirm('Muốn xóa ko?')">
